...
const StaffNotifications = () => {
  ...
  const fetchAlerts = async () => {
    ...
    try {
      ...
      console.error(err);
      setError("Unable to load notifications. Check connection to the server.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div style={{ animation: "fadeIn 0.3s ease" }}>
      <div className="page-header">
        <div className="page-title-area">
          <h2>Notifications ({alerts.length})</h2>
          <p>Review system stock alerts and reorder notifications.</p>
        </div>
        {unreadCount > 0 && (
          <button 
